...
extension KorKeyboardView {
    ...
    func addViews() {
        [horizontal1, horizontal1Shift, horizontal2, horizontal3, spaceBar, returnButton, shortcutButton].forEach { self.addSubview($0) }
    }
    
    func setConstraints() {
        [horizontal1, horizontal1Shift, horizontal2, horizontal3, spaceBar, returnButton, shortcutButton].forEach { $0.translatesAutoresizingMaskIntoConstraints = false }
        ...
        NSLayoutConstraint.activate([
            ...
            shortcutButton.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 4),
            shortcutButton.topAnchor.constraint(equalTo: horizontal3.bottomAnchor, constant: 12),
            shortcutButton.widthAnchor.constraint(equalTo: self.widthAnchor, multiplier: 0.25),
            spaceBar.leadingAnchor.constraint(equalTo: shortcutButton.trailingAnchor, constant: 6),
            spaceBar.topAnchor.constraint(equalTo: shortcutButton.topAnchor),
