...
class PurchaseReviewCollectionViewCell: UICollectionViewCell {
    ...
    static let identifier = "PurchaseReviewCollectionViewCell"
...
//            idLabel.trailingAnchor.constraint(equalTo: trailingAnchor),
            ...
            infoLabel.trailingAnchor.constraint(equalTo: messageView.trailingAnchor),
            
            timeLabel.topAnchor.constraint(equalTo: uesrImage.bottomAnchor,constant: 4),
...
//            timeLabel.trailingAnchor.constraint(equalTo: infoLabel.trailingAnchor),
            timeLabel.bottomAnchor.constraint(equalTo: self.bottomAnchor,constant: -5),
