...
class MainViewController: UIViewController {
    ...
    private func setUpUIConstraints() {
        NSLayoutConstraint.activate([
            ...
            firstView.leadingAnchor.constraint(equalTo: sdView.leadingAnchor,constant: 0),
            firstView.trailingAnchor.constraint(equalTo: sdView.trailingAnchor,constant: 0),
...
//            secondView.heightAnchor.constraint(equalToConstant: 500),
            ...
            thirdView.leadingAnchor.constraint(equalTo: sdView.leadingAnchor,constant: 0),
            thirdView.trailingAnchor.constraint(equalTo: sdView.trailingAnchor,constant: 0),
...
//            thirdView.heightAnchor.constraint(equalToConstant: 202),
            ...
            fourView.leadingAnchor.constraint(equalTo: sdView.leadingAnchor,constant: 0),
            fourView.trailingAnchor.constraint(equalTo: sdView.trailingAnchor,constant: 0),
            
            
            fifveView.topAnchor.constraint(equalTo: fourView.bottomAnchor),
            fifveView.leadingAnchor.constraint(equalTo: sdView.leadingAnchor,constant: 0),
            fifveView.trailingAnchor.constraint(equalTo: sdView.trailingAnchor,constant: 0),
